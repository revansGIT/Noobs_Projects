class Converter:
	...
	def CeltoKel(self):
		...
		if self.k <= 243.15:
			print (self.k, 'degree K, Very cold if you are outside in this temperature, unbearable to most')
		elif self.k < 273.15:
			print(self.k, 'degree K, Very cold still but bearable if in lots of warm clothes')
		elif self.k >= 273.15 and self.k < 277.15:
			print(self.k, 'degree K, Cold! Typical coldest average temperature for UK in winter')
		elif self.k >= 277.15 and self.k < 283.15:
			print(self.k, 'degree K, Cold! Water has its smallest volume at this temperature')
		elif self.k >= 283.15 and self.k < 298.15:
			print(self.k, 'degree K, Cold to Warm!')
		elif self.k >= 298.15 and self.k < 303.15:
			print(self.k, 'degree K, Warm to Hot! Typical maximum temperature for British summer')
		elif self.k >= 303.15 and self.k < 310.15:
			print(self.k, 'degree K, Feeling hot! Typical temperature for hotter countries')
		elif self.k >= 310.15 and self.k < 323.15:
			print(self.k, 'degree K, Very hot! If you are outside in this temperature you will feel hot, but more so if humidity is high. If your internal body temperature reaches this level you are in danger of death')
		elif self.k >= 323.15 and self.k < 333.15:
			print(self.k, 'degree K, Extremely hot! Not many places get this high in temperature, and this heat you would need to find shade, drink water and stay cool.')
		elif self.k >= 333.15 and self.k < 363.15:
			print(self.k, 'degree K, Too hot to live in! Most bacteria die at this temperature')
		else:
			print(self.k, 'degree K, Too hot to live in! Humans cannot survive such high temperatures')

	def FartoKel(self):
		ans = (self.f - 32) * 5/9 + 273.15
		return ans
